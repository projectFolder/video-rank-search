    ...
    public class HttpWebRequetClass
    {
        ...
        private String pc_searchKeyword(String keyWord, String searchUrl)
        {
            ...
            for (int i = 0; i < pageVal.Length-1; i++)
            {
                ...
                String Url = "https://search.naver.com/search.naver?where=video&ie=utf8&sort=rel&listmode=v&stype=&period=&playtime=&selected_cp=&nso=&x_video=&sm=tab_pge&query=" + HttpUtility.UrlEncode(keyWord) + "&start=" + pageVal[i] + "&offset=1";
                ...
                PostReq.Referer = "https://search.naver.com/search.naver?where=video&ie=utf8&sort=rel&listmode=v&stype=&period=&playtime=&selected_cp=&nso=&x_video=&sm=tab_pge&query=";
                ...
                {
                    foreach (String val in Html.Split(new String[] { "video_item  video_on _item _direct_view" }, StringSplitOptions.RemoveEmptyEntries))
                    {
